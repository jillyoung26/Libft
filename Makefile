...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/05/03 09:18:13 by jyoung            #+#    #+#              #
#    Updated: 2019/05/22 17:02:01 by jyoung           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_lstdelone.c\
ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_lstnew.c\
...
ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_lstdelone.o\
ft_lstdel.o ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_lstnew.o\
